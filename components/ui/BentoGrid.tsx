...
export const BentoGridItem = ({
  ...
  const rightLists = ["JavaScript", "SQL", "CSS"];
  ...
  const handleCopy = () => {
    const text = "contact.tasmiia@gmail.com";
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: "linear-gradient(135deg, #1c1c1c 0%, #2e2e2e 100%);",
      }}
    >
      {/* add img divs */}
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          <div className="font-sans font-light md:max-w-32 md:text-xs lg:text-base text-sm text-[#dbddf6] z-10 ">
            <p>{description}</p>
          </div>
