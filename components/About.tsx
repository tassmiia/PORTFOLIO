    ...
    <section className="min-h-screen flex items-center bg-black text-white py-16">
      <div className="container mx-auto px-6 lg:px-20 flex flex-col md:flex-row items-center">
        ...
        <div className="w-full md:w-1/2 md:pr-8">
          ...
          <p className="text-lg md:text-xl font-mono text-zinc-400 leading-relaxed mb-6">
            ...
            , I enjoy bringing designs to life using several programming
            ...
            . When I'm not immersed in the world of pixels, you'll find me
            adoring cats.😽
          </p>
          <p className="text-lg md:text-xl leading-relaxed font-mono text-zinc-500">
